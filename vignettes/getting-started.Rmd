...
- `PDMR` stands for Plain DMR and it is a threshold parameter agnostic variant of GLAMER algorithm [Nowakowski *et al.*, 2022]. It can be used both for $p<n$ and $p \geq n$ scenarios. 
